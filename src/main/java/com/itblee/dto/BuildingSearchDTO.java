...
public class BuildingSearchDTO implements Serializable {
    private String name;
    ...
    public String getRentTypeCodes() {
        return rentTypeCodes;
    }

    public void setRentTypeCodes(String rentTypeCodes) {
